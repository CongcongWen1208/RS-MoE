...
class RunnerBase:
    ...
    def train_epoch(self, epoch):
        # train
        self.model.train()
        print('self.task.train_epoch',self.task.train_epoch)
        '''self.task.train_epoch <bound method BaseTask.train_epoch of <lavis.tasks.vqa.IconQATask object at 0x1554463164c0>>'''
