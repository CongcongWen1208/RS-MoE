...
class Blip2T5InstructLoRA(Blip2Base):
    ...
    def __init__(
        ...
        # self.t5_tokenizer = T5TokenizerFast.from_pretrained(t5_model, truncation_side='left',cache_dir='/scratch/sg7484/ra/InstructBLIP_PEFT/results/output')
        # self.t5_output_tokenizer = T5TokenizerFast.from_pretrained(t5_model, truncation_side='right',cache_dir='/scratch/sg7484/ra/InstructBLIP_PEFT/results/output')
        # print('self.t5_tokenizer: ',self.t5_tokenizer)
        # print('self.t5_output_tokenizer: ',self.t5_output_tokenizer)
        # t5_config = T5Config.from_pretrained(t5_model,cache_dir='/scratch/sg7484/ra/InstructBLIP_PEFT/results/output')
        # print('T5Config.from_pretrained: ',T5Config.from_pretrained)
        # t5_config.dense_act_fn = "gelu"
        # print('T5ForConditionalGeneration.from_pretrained: ',T5ForConditionalGeneration.from_pretrained)
        # '''self.t5_tokenizer:  T5TokenizerFast(name_or_path='google/flan-t5-xl', vocab_size=32100, model_max_length=512, is_fast=True, padding_side='right', truncation_side='left', special_tokens={'eos_token': '</s>', 'unk_token': '<unk>', 'pad_token': '<pad>', 'additional_special_tokens': ['<extra_id_0>', '<extra_id_1>', '<extra_id_2>', '<extra_id_3>', '<extra_id_4>', '<extra_id_5>', '<extra_id_6>', '<extra_id_7>', '<extra_id_8>', '<extra_id_9>', '<extra_id_10>', '<extra_id_11>', '<extra_id_12>', '<extra_id_13>', '<extra_id_14>', '<extra_id_15>', '<extra_id_16>', '<extra_id_17>', '<extra_id_18>', '<extra_id_19>', '<extra_id_20>', '<extra_id_21>', '<extra_id_22>', '<extra_id_23>', '<extra_id_24>', '<extra_id_25>', '<extra_id_26>', '<extra_id_27>', '<extra_id_28>', '<extra_id_29>', '<extra_id_30>', '<extra_id_31>', '<extra_id_32>', '<extra_id_33>', '<extra_id_34>', '<extra_id_35>', '<extra_id_36>', '<extra_id_37>', '<extra_id_38>', '<extra_id_39>', '<extra_id_40>', '<extra_id_41>', '<extra_id_42>', '<extra_id_43>', '<extra_id_44>', '<extra_id_45>', '<extra_id_46>', '<extra_id_47>', '<extra_id_48>', '<extra_id_49>', '<extra_id_50>', '<extra_id_51>', '<extra_id_52>', '<extra_id_53>', '<extra_id_54>', '<extra_id_55>', '<extra_id_56>', '<extra_id_57>', '<extra_id_58>', '<extra_id_59>', '<extra_id_60>', '<extra_id_61>', '<extra_id_62>', '<extra_id_63>', '<extra_id_64>', '<extra_id_65>', '<extra_id_66>', '<extra_id_67>', '<extra_id_68>', '<extra_id_69>', '<extra_id_70>', '<extra_id_71>', '<extra_id_72>', '<extra_id_73>', '<extra_id_74>', '<extra_id_75>', '<extra_id_76>', '<extra_id_77>', '<extra_id_78>', '<extra_id_79>', '<extra_id_80>', '<extra_id_81>', '<extra_id_82>', '<extra_id_83>', '<extra_id_84>', '<extra_id_85>', '<extra_id_86>', '<extra_id_87>', '<extra_id_88>', '<extra_id_89>', '<extra_id_90>', '<extra_id_91>', '<extra_id_92>', '<extra_id_93>', '<extra_id_94>', '<extra_id_95>', '<extra_id_96>', '<extra_id_97>', '<extra_id_98>', '<extra_id_99>']}, clean_up_tokenization_spaces=True)
        # self.t5_output_tokenizer:  T5TokenizerFast(name_or_path='google/flan-t5-xl', vocab_size=32100, model_max_length=512, is_fast=True, padding_side='right', truncation_side='right', special_tokens={'eos_token': '</s>', 'unk_token': '<unk>', 'pad_token': '<pad>', 'additional_special_tokens': ['<extra_id_0>', '<extra_id_1>', '<extra_id_2>', '<extra_id_3>', '<extra_id_4>', '<extra_id_5>', '<extra_id_6>', '<extra_id_7>', '<extra_id_8>', '<extra_id_9>', '<extra_id_10>', '<extra_id_11>', '<extra_id_12>', '<extra_id_13>', '<extra_id_14>', '<extra_id_15>', '<extra_id_16>', '<extra_id_17>', '<extra_id_18>', '<extra_id_19>', '<extra_id_20>', '<extra_id_21>', '<extra_id_22>', '<extra_id_23>', '<extra_id_24>', '<extra_id_25>', '<extra_id_26>', '<extra_id_27>', '<extra_id_28>', '<extra_id_29>', '<extra_id_30>', '<extra_id_31>', '<extra_id_32>', '<extra_id_33>', '<extra_id_34>', '<extra_id_35>', '<extra_id_36>', '<extra_id_37>', '<extra_id_38>', '<extra_id_39>', '<extra_id_40>', '<extra_id_41>', '<extra_id_42>', '<extra_id_43>', '<extra_id_44>', '<extra_id_45>', '<extra_id_46>', '<extra_id_47>', '<extra_id_48>', '<extra_id_49>', '<extra_id_50>', '<extra_id_51>', '<extra_id_52>', '<extra_id_53>', '<extra_id_54>', '<extra_id_55>', '<extra_id_56>', '<extra_id_57>', '<extra_id_58>', '<extra_id_59>', '<extra_id_60>', '<extra_id_61>', '<extra_id_62>', '<extra_id_63>', '<extra_id_64>', '<extra_id_65>', '<extra_id_66>', '<extra_id_67>', '<extra_id_68>', '<extra_id_69>', '<extra_id_70>', '<extra_id_71>', '<extra_id_72>', '<extra_id_73>', '<extra_id_74>', '<extra_id_75>', '<extra_id_76>', '<extra_id_77>', '<extra_id_78>', '<extra_id_79>', '<extra_id_80>', '<extra_id_81>', '<extra_id_82>', '<extra_id_83>', '<extra_id_84>', '<extra_id_85>', '<extra_id_86>', '<extra_id_87>', '<extra_id_88>', '<extra_id_89>', '<extra_id_90>', '<extra_id_91>', '<extra_id_92>', '<extra_id_93>', '<extra_id_94>', '<extra_id_95>', '<extra_id_96>', '<extra_id_97>', '<extra_id_98>', '<extra_id_99>']}, clean_up_tokenization_spaces=True)
        # T5Config.from_pretrained:  <bound method PretrainedConfig.from_pretrained of <class 'transformers.models.t5.configuration_t5.T5Config'>>
        # T5ForConditionalGeneration.from_pretrained:  <bound method PreTrainedModel.from_pretrained of <class 'lavis.models.blip2_models.modeling_t5.T5ForConditionalGeneration'>>'''
        # self.t5_model = T5ForConditionalGeneration.from_pretrained(
        #     t5_model, config=t5_config,cache_dir='/scratch/sg7484/ra/InstructBLIP_PEFT/results/output'
        # )
        
        self.llama_model, self.llama_tokenizer = self.init_llm(
            llama_model_path='/scratch/sg7484/ra/MiniGPT-4/vicuna',
            low_resource=False,
            low_res_device=0,
            lora_r=0,
        ...
        '''llama_model:  /scratch/sg7484/ra/MiniGPT-4/vicuna
            low_resource:  False
            device_8bit:  0
            lora_r:  0
            lora_target_modules:  ['q_proj', 'v_proj']
    ...
    def forward(self, samples):
        ...
        if self.qformer_text_input:
            # print('self.qformer_text_input: ',self.qformer_text_input)
            ...
            # print('text_Qformer: ',text_Qformer)
        ...
        with self.maybe_autocast(dtype=torch.bfloat16):
            ...
            outputs_text_text = self.t5_model.generate(
                inputs_embeds=inputs_embeds,
                attention_mask=encoder_atts,
                do_sample=False,
                top_p=0.9,
            ...
            output_text = self.t5_tokenizer.batch_decode(
                outputs_text_text, skip_special_tokens=True
            )
            for i in range(len(output_text)):
                print(f'samples["text_input"]{i}: ',samples["text_input"][i])
                print(f'output_text{i}: ',output_text[i])
                print(f'samples["text_output"]{i}: ',samples["text_output"][i])
            # loss = outputs.loss

            return output_text#{"loss": loss}
